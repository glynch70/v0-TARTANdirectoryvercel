...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Bento Grid */}
      <div className="px-4 py-6 space-y-4 max-w-2xl mx-auto pb-32">
        {/* Browse Directory */}
        <Link href="/directory">
          <div className="bento-card-lg bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 cursor-pointer group">
        ...
        {/* Explore Trades */}
        <Link href="/trades">
          <div className="bento-card-lg bg-gradient-to-br from-teal-600 to-emerald-700 border-teal-500 cursor-pointer group">
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 rounded-lg bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition">
        ...
        <div className="bento-card-lg bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
        ...
        {/* About Section */}
        <Link href="/about">
          <div className="bento-card-lg bg-gradient-to-br from-indigo-50 to-blue-50 border-indigo-200 cursor-pointer group">
            <div className="flex items-start justify-between mb-4">
            ...
            <p className="text-slate-600 text-sm">Learn about our mission, values, and the community we're building.</p>
          </div>
        </Link>

        {/* Get In Touch */}
        <div className="bento-card-lg bg-gradient-to-br from-rose-50 to-pink-50 border-rose-200">
          <div className="flex items-start justify-between mb-4">
          ...
          <p className="text-slate-600 text-sm mb-4">Interested in joining Tartan Talks? We'd love to hear from you.</p>
